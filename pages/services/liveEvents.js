...
import Hero from '../../assets/service-heros/live-events-hero.jpg';
import SummaryImg from '../../assets/events-summary.jpg';
    ...
    <ServicesPage>
      ...
      <main>
        ...
        <IconCards>
          ...
          <IconCard>
            <i class="icon-calendar card-icon" />
          ...
          <IconCard>
            <i class="icon-retweet card-icon" />
            <h5>Production</h5>
            <p>
              Unlike other web development agencies, we’re able to provide
              ongoing optimisations and development as best practices evolve to
